...
let  SPPTDLN_Report_Raw= [
    "Reference|40|Nilai referensi unik untuk setiap transaksi, disusun dengan format: <br/> <4CharPSPCode>_<unixTimeStamp>_<retrievalRefNumber >",
    "Total Amount|20|Jumlah keseluruhan nilai transaksi yang ditagihkan termasuk pajak",
    "VAT Amount|20|Nilai total Pajak (VAT) yang dikenakan pada transaksi. Nilai ini merupakan<br/>nilai yang akan di settle ke Jalin.",
    "Merchant Amount|20|Jumlah dana bersih yang diterima merchant setelah potongan biaya dan pajak",
    "Transaction Fee|20|Biaya transaksi yang dikenakan untuk proses pembayaran",
    "Transaction VAT|20|Nilai pajak yang dikenakan atas biaya transaksi (VAT atas fee)",
    "Dispute VAT Amount|20|Nilai kurs yang didapatkan pada Web Kemenkeu pada saat tgl cutof",
    "Kurs|3|Nilai kurs yang diambil dari situs resmi Kementerian Keuangan (Kemenkeu) padatanggal cutof",
    "Currency|3|Mata Uang ayng digunakan dalam laporan",
    "Status|30|Parameter penentu yang digunakan untuk mengidentifikasi apakah suatu<br/>transaksi dikenakan pemotongan Pajak Pertambahan Nilai (VAT) atau tidak.",
    "Created At|20|Waktu saat melakukan verify Transaction ke jalin",
    "Client Name|30|Nama Merchant yang melakukan transaksi",
    "MCC|6|Kode kategori merchant (Merchant Category Code) yang menunjukkan jenis usaha atau layanan merchant",
    "Merchant Country|20|Kode Negara tempat merchant terdaftar atau beroperasi",
    "Payment Method|25|Jenis pembayaran <br/> Debit/Credit/Wallet/Current Account/ Saving Account",
    "PSP Name|20|Nama institusi penerbit (issuer) atau penyedia jasa pembayaran yang melakukan proses transaksi ",
    "Sector|20|Kategori atau jenis usaha dari merchant yang melakukan transasksi",
    "Audit Flagged|10|Alasan atau keterangan yang menjlaskan peyebab transaksi di flag <br/> Nilai True berearti transaksi  diflag yang ditinjau",
    "Audit Reason|20|Deskripsi dari Audit Flagged",
    "PSP Reconcilled|20|Status hasil rekonsiliasi dengan PSP <br/> Nilai TRUE menandakan data valid untuk proses pelaporan, settlement, atau perhitungan VAT",
    "PSP Reconcilled AT|20|Waktu terjadinya rekonsiliasi transaksi dengan PSP. <br/> Format ISO 8601 (UTC+7): <br/> yyyy-MMddTHH:mm:ss.SSSTZD",
    "Service|15|Jenis Claim dari transaksitersebut. <br/> Decline/Chargeback",
]
